...
import com.androstock.myweatherapp.Service.NetworkCall;
import com.androstock.myweatherapp.Service.Veriler;
import com.androstock.myweatherapp.Service.WeatherPOJO;
import com.androstock.myweatherapp.location.LocationActivity;
import com.androstock.myweatherapp.settings.SettingActivity;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.konum_kullan:
                Intent intent=new Intent(WeatherActivity.this, LocationActivity.class);
                startActivity(intent);
                return true;
            case R.id.action_settings:
                Intent intentToSet=new Intent(getApplicationContext(), SettingActivity.class);
                startActivity(intentToSet);
                // ayarlar sayfası yada fragment ekeleme
                return true;
    ...
    //verileri güncelliyor ilk açınca yapılmış sadece
