...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
     holder.tvMain.setText(list.get(position).getMains());
        ...
        holder.tvTemp.setText("Sıcaklık:" + String.format(list.get(position).getTemp())+"°");
        holder.tvHumidity.setText("Nem: " + list.get(position).getHumidity() + "%");
        holder.tvPressure.setText("Basınc: " + list.get(position).getPressure() + " hPa");
        holder.tvDate.setText("Son Güncelleme: " + convertDateFormat(list.get(position).getDate()));
